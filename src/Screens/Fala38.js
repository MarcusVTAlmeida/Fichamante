...
function Fala38({ route, navigation }) {
  ...
  const { text } = route.params;
   ...
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala39'   , { text: text})}}>
   ...
   <TouchableOpacity style={{top: 275, position: 'absolute', left:-25}} onPress={() => {
          navigation.navigate('Fala37'   , { text: text})}}>
    <Image style={{  height:40, width: 70, resizeMode:"contain"}} 
