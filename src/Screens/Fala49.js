...
function Fala49({ route, navigation }) {
  ...
  const { value } = route.params;
   ...
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala50'   , {value: value, text: text})}}>
   ...
   <TouchableOpacity style={{top: 275, position: 'absolute', left:-25}} onPress={() => {
          navigation.navigate('Fala48'   , {value: value, text: text})}}>
    <Image style={{  height:40, width: 70, resizeMode:"contain"}} 
