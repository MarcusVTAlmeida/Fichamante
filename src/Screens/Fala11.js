...
function Fala11({ route, navigation }) {
    ...
    <Text style={{fontSize: 20, color: "black", top:240, position: 'absolute', left: 80}}>???</Text>
        <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>    Opa, um segundinho já te atendo.
</Text>     
    </View>              
   
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala12' )}}>
