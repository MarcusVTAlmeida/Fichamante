...
function Fala39({ route, navigation }) {
  ...
  const { text } = route.params;
    ...
    <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>   Okay, então o primeiro atributo a ser preenchido são as Raças… 

</Text>
    </View>            
   
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala40'   , { text: text})}}>
   ...
   <TouchableOpacity style={{top: 275, position: 'absolute', left:-25}} onPress={() => {
          navigation.navigate('Fala38'   , { text: text})}}>
    <Image style={{  height:40, width: 70, resizeMode:"contain"}} 
