...
function Fala40({ route, navigation }) {
  ...
  const { text } = route.params;
    ...
    <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>    Eita, espera aí!Calcifer, puxa o meu painel fazendo um favorzinho.

</Text>
    </View>            
   
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala41'   , { text: text})}}>
   ...
   <TouchableOpacity style={{top: 275, position: 'absolute', left:-25}} onPress={() => {
          navigation.navigate('Fala39'   , { text: text})}}>
    <Image style={{  height:40, width: 70, resizeMode:"contain"}} 
