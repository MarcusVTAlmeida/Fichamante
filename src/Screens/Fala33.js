...
function Fala33({ route, navigation }) {
  ...
  const { text } = route.params;
    ...
    <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>    Ele também define o que você pode escolher para montar seu personagem, como
</Text>
   ...
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala34'   , { text: text})}}>
   ...
   <TouchableOpacity style={{top: 275, position: 'absolute', left:-25}} onPress={() => {
          navigation.navigate('Fala32'   , { text: text})}}>
    <Image style={{  height:40, width: 70, resizeMode:"contain"}} 
