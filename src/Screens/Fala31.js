...
function Fala31({ route, navigation }) {
  ...
  const { text } = route.params;
    ...
    <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>   O que é um sistema, você me pergunta? Bom, um sistema é um conjunto de regras 
</Text>
   ...
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala32'   , { text: text})}}>
   ...
   <TouchableOpacity style={{top: 275, position: 'absolute', left:-25}} onPress={() => {
          navigation.navigate('Fala30'   , { text: text})}}>
    <Image style={{  height:40, width: 70, resizeMode:"contain"}} 
