...
function Fala15({ route, navigation }) {
    ...
    <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>     De dentro da porta dos fundos, sai uma jovem Elfa carregando uma pilha
</Text>
   ...
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala16' )}}>
