...
function Fala19({ route, navigation }) {
    ...
    <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>    Prazer, meu nome é Nina! Bem, isso você já deve saber por causa do nome da
</Text>
        <Text style={{fontSize: 16, color: "black", top: 280, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>loja hehe! Eu não sou muito boa com nomes.
Nina: Ah! E esse é o Calcifer meu fiel</Text>
<Text style={{fontSize: 16, color: "black", top: 295, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>ajudante, segurança da loja e mascote nas horas vagas!</Text>
   ...
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala21' )}}>
