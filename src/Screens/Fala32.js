...
function Fala32({ route, navigation }) {
  ...
  const { text } = route.params;
    ...
    <Text style={{fontSize: 16, color: "black", top: 265, position: 'absolute', left: "12%", fontFamily: 'LangarRegular'}}>     Ele define todas as regras como, os monstros que existem, que tipo de 
</Text>
   ...
   <TouchableOpacity style={{top: 280, position: 'absolute', left: 720}} onPress={() => {navigation.navigate('Fala33'   , { text: text})}}>
   ...
   <TouchableOpacity style={{top: 275, position: 'absolute', left:-25}} onPress={() => {
          navigation.navigate('Fala31'   , { text: text})}}>
    <Image style={{  height:40, width: 70, resizeMode:"contain"}} 
